...
public class CustomChiperSuites {
    private final OkHttpClient client;

    public CustomChiperSuites(List<CipherSuite> customCipherSuites) throws GeneralSecurityException {
...
//        }
        ...
        final ConnectionSpec spec = new ConnectionSpec.Builder(true)
    ...
    public CustomChiperSuites(OkHttpClient client) {
        this.client = client;
    }
